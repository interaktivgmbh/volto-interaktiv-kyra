...
myst:
  html_meta:
    ...
    "property=og:title": "clean-volto-template"
    "keywords": "clean-volto-template, documentation, A new project using Plone 6."
---

# clean-volto-template

Welcome to the documentation for clean-volto-template!
