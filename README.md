...
[![Version](https://img.shields.io/badge/version-1.1-blue.svg)](https://github.com/interaktivgmbh/volto-interaktiv-kyra)
...
> **Features** — [Translation](#translation) · [Translation Sync](#translation-sync) · [AI Chat](#ai-chat) · [Edit Mode](#edit-mode) · [Layout Agent](#layout-agent) · [Text Selection](#text-selection) · [Prompts](#prompt-management) · [Slate Integration](#slate-editor-integration) · [File Attachments](#prompt-file-attachments) · [History](#chat-history) · [Customization](#customization)
>
