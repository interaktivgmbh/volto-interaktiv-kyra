...
export const postAiChat = async (
  ...
  if (!response.ok) {
    ...
    throw new Error(parseErrorText(errorText) ||'AI chat request failed');
  }
...
export const postAiFeedback = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI feedback request failed');
  }
};
...
export const getAiCapabilities = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI capabilities request failed');
  }
...
export const postAiActionsPlan = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI actions plan request failed');
  }
...
export const postAiActionsApply = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI actions apply request failed');
  }
...
export const postAiChatUpload = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI chat upload failed');
  }
...
export const postAiChatStream = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI chat stream request failed');
  }
...
export const postTagMapping = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Tag mapping save failed');
  }
...
export const deleteTagMapping = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Tag mapping delete failed');
  }
...
export const getAiChatTranslations = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'AI chat translations request failed');
  }
...
export const postGlossaryEntry = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Glossary entry save failed');
  }
...
export const deleteGlossaryEntry = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Glossary entry delete failed');
  }
...
export const importGlossaryCsv = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'CSV import failed');
  }
...
export const deletePromptFile = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'File deletion failed');
  }
...
export const createPrompt = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Prompt creation failed');
  }
...
export const updatePrompt = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Prompt update failed');
  }
...
export const deletePrompt = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Prompt deletion failed');
  }
...
export const createLayoutConversation = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Failed to create layout conversation');
  }
...
export const sendLayoutMessage = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Failed to send layout message');
  }
...
export const pollLayoutJob = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Failed to poll layout job');
  }
...
export const cancelLayoutJob = async (
  ...
  if (!response.ok) {
    const errorText = await response.text();
    throw new Error(parseErrorText(errorText) ||'Failed to cancel layout job');
  }
