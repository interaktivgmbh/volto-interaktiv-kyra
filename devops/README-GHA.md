...
2. Go to your repository at [collective/clean-volto-template](https://github.com/collective/clean-volto-template).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `clean-volto-template.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | clean-volto-template.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | clean-volto-template.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/clean-volto-template/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/clean-volto-template/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/clean-volto-template-backend`) and Frontend (`ghcr.io/collective/clean-volto-template-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of clean-volto-template.example.com](https://github.com/collective/clean-volto-template/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/clean-volto-template.example.com.yml` stack.
